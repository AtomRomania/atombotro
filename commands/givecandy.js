...
exports.run = (client, message, args, tools) => {
  ...
  .setColor(0xFF0000)
  .setTitle(`:candy: ${message.author.username} Si-a cumparat o acadea :)! :candy:`)
  ...
  .setColor(0xFF0000)
  .setTitle(`:candy: ${message.author.username} ia  dat lui ${message.mentions.members.first().user.username} o acadea :)!:candy:`)
